    ...
    <div className="mx-4">
      <section className="xl:max-w-screen-xl mb-16  mx-auto md:mb-36 text-fondoBlanco  md:px-0 mt-10">
        <div className="md:grid md:grid-cols-12 md:grid-rows-4 md:gap-3 mb-3 items-stretch overflow-hidden lg:h-[941px] ">
          <div className="md:col-span-5 md:col-start-8 lg:h-[941px]">
            <Link
          ...
          <div className="md:col-span-7 md:row-start-3 md:row-span-2 flex">
            <Link
              ...
              id="2"
            >
              <div className="texto_image bottom-0 rounded-b-2xl absolute z-30 px-10 w-full h-40 flex  flex-row text-center justify-between px-10 items-center cursor-pointer transition-all duration-200 bg-black/50">
                <div className="group-hover:pr-20  w-full  transition-all duration-300">
                  <h3 className="text-3xl md:mb-4 italic">
