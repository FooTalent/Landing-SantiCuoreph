          ...
          <div key={slideImage.index} className="h-[438px] md:h-full">
            <Link href={slideImage.link}>
              <div className="md:h-screen relative flex items-center">
                ...
                <p className="text-fondoBlanco absolute font-merriwather font-bold   lg:text-7xl text-xl md:text-[2rem] lg:left-[105px] left-10 lg:bottom-44 bottom-28 md:bottom-56 drop-shadow-[0_8px_5px_rgb(0,0,0,0.8)]">
                  {slideImage.caption2}
                </p>
                <p className="lg:left-[105px] font-nunitoSans absolute font-light italic text-fondoBlanco md:text-[2rem] left-10 lg:bottom-28 md:bottom-40 bottom-20 drop-shadow-[0_8px_5px_rgb(0,0,0,0.8)]">
                  {slideImage.caption}
                </p>
              </div>
            </Link>
