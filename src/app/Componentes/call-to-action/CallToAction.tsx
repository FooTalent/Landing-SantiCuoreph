    ...
    return (
        <section className="mx-auto text-2xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl flex flex-col justify-center items-center gap-[1.25em] md:gap-[1.25em] relative">
            ...
            {/*<CustomButton
                ...
                */}
                <Link href="/contacto" className="text-xl sm:text-2xl md:text-3xl lg:text-4xl py-[0.5em] px-[2em] bg-principal rounded-full merriwather font-bold text-fondoNegro hover:bg-principalHover hover:font-extrabold">
                    Contactame
